...
import { adminApproval, supervisorApproval, getPendingApprovals } from '../controllers/approval.controllers.js'

const router = express.Router()

router.get('/approval/pending', authMiddleware, getPendingApprovals);
